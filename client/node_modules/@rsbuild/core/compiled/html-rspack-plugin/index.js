(() => {
  var __webpack_modules__ = {
    534: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      const { HtmlWebpackChildCompiler } = __nccwpck_require__(751);
    ...
    683: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
    ...
    763: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      const promisify = __nccwpck_require__(23).promisify;
      const vm = __nccwpck_require__(154);
      const fs = __nccwpck_require__(896);
      const path = __nccwpck_require__(928);
      const { CachedChildCompilation } = __nccwpck_require__(534);
      const { createHtmlTagObject, htmlTagObjectToString, HtmlTagArray } =
        __nccwpck_require__(282);
      const prettyError = __nccwpck_require__(548);
      const chunkSorter = __nccwpck_require__(341);
      const getHtmlRspackPluginHooks =
        __nccwpck_require__(683).getHtmlRspackPluginHooks;
